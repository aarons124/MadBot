...
module.exports = {
  ...
  description: "Stop/clear the queue.",
  usage: "stop",
  ...
  run: async (client, message, args) => {
    ...
    try {
      ...
      // If everything above is executed correctly, we stop the queue and react to the message as a confirmation
      await client.distube.stop(message);
      await message.react("⏹️");
    } catch (e) {
      // Catch if there is any errors
      console.log(`[STOP_COMMAND]: ${e}`);
    }
  }
}